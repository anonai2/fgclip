...
def main():
    ...
    # 모든 layer의 mlp, ln만 학습하도록 패턴 구성
    vision_blocks_pattern = r"^visual\.transformer\.resblocks\.\d+\.(mlp|ln_)"
    text_blocks_pattern = r"^transformer\.resblocks\.\d+\.(mlp|ln_)"
    ...
    print(f"🔢 Model parameters: total={total_params:,}, trainable={trainable_params:,} ({trainable_params/total_params*100:.2f}%)")
